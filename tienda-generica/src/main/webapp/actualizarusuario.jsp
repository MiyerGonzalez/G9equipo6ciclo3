...
<body>
	...
	<div style="padding-left: 5px">
		<h1>
			<i class="fas fa-plus-circle"></i> Actualizar datos de usuario
		</h1>
		<div class="container">
		
		
			<div id="error" class="alert alert-danger visually-hidden"
					role="alert">Error al actualizar el usuario, verifique que no exista un usuario con la cedula y usuario dados</div>
