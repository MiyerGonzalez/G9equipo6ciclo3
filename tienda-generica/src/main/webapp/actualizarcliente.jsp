...
<body>
	...
	<div style="padding-left: 5px">
		<h1>
			<i class="fas fa-plus-circle"></i> Actualizar datos del cliente
		</h1>
		<div class="container">
		
		
			<div id="error" class="alert alert-danger visually-hidden"
					role="alert">Error al actualizar el cliente, verifique que no exista un cliente con la cedula y usuario dados</div>
	...
	<script>
		function enviar() {
			...
			for (i = 0; i < clientes.length; i++) {
				...
				if (clientes[i].telefono_cliente ==x ) {
